...
def gather_base_context():
    ...
    context = {"menus": menus, "shopname": "CyberShop", "menu_text": "Назад"}
    return context
...
def archive(request, item):
    ...
    context = {"title": "Archive", "item": item_to_display}
    context.update(gather_base_context())
